> **Version:** v1, adopted July 8, 2025  

# Requirements and Criteria for Participation for the Tazama Mission Committee
...
### 2. Term Voting Representatives

Term voting representatives serve for a period of one (1) year.

- Qualified nonprofit organizations that provide financial support to the Tazama open source project, a project of LFC, through donations or grants, shall be eligible to nominate an individual for one voting seat on the Mission Committee. Seating of a nominee to the Committee is subject to approval by a majority vote of the Committee.
- Additionally, the Committee may directly appoint a term voting member from any charitable organization, nonprofit, government agency, or private foundation that has not provided funding, provided the appointment is approved by a majority vote of the Committee.
...
The Mission Committee follows the compliance rules and procedures defined in the [Tazama Technical Charter](https://github.com/tazama-lf/technical-steering-committee/blob/dev/CHARTER.md#6-compliance-with-policies).
